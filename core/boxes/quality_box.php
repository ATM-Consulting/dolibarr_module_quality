 ...
 */
class qualitybox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "quality@quality";
    public $boxlabel;
    public $depends = array("quality");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/quality/class/quality.class.php";
